...
Task 2: Mininet Wifi: A Platform for Hybrid Physical-Virtual
Software-Defined Wireless Networking Research

###############################################################
Total packets sent/received,packets loss,throughput and latency
...
def topology():
	...
	#car0 doesnt need now to connect with the other cars but straight to AP's
    ...
    graphic2()	  #for packets dropped (through ifconfig)
